...
def main():
    ...
    def graphPlot(plot_field, ref):
        ...
        plt_name = "test_dealiasing_%s.png" % datetime.now().strftime(
            r"%d_%m_%Y_%H_%M_%S"
        )
    ...
    dds_radd_eff_unamb_vel = radar.instrument_parameters["unambiguous_range"][
        "data"
    ].tolist()[
        0
    ]  # 108620.65 m
    ...
    radar.add_field_like(
        "velocity",
        "velocity_forced_unfolding",
        forced_unfolding_mask,
