...
def despeckle(input_list, bad, a_speckle, input_boundary_mask, dgi_clip_gate=None, boundary_mask_all_true=False):
    ...
    se_despeckle(input_array, output_array, ctypes.c_size_t(data_length), ctypes.c_float(bad), ctypes.c_int(a_speckle), ctypes.c_size_t(dgi_clip_gate), boundary_array)
