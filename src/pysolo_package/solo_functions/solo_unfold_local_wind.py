...
def unfold_local_wind(input_list_data, bad, nyquist_velocity, dds_radd_eff_unamb_vel, azimuth_angle_degrees, elevation_angle_degrees, ew_wind,  ns_wind,  ud_wind, max_pos_folds, max_neg_folds, ngates_averaged, input_list_mask=None, dgi_clip_gate=None, boundary_mask=None):
    """
        Performs a <TODO>
    ...
    se_unfold_local_wind.restype = None
    se_unfold_local_wind.argtypes = [
        ...
        ctypes.c_float,                     # azimuth_angle_degrees
        ctypes.c_float,                     # elevation_angle_degrees
        ctypes.c_float,                     # ew_wind
        ctypes.c_float,                     # ns_wind
        ctypes.c_float,                     # ud_wind
    ...
    se_unfold_local_wind(
        ...
        ctypes.c_float(azimuth_angle_degrees),      # azimuth_angle_degrees
        ctypes.c_float(elevation_angle_degrees),    # elevation_angle_degrees
        ctypes.c_float(ew_wind),                    # ew_wind
        ctypes.c_float(ns_wind),                    # ns_wind
        ctypes.c_float(ud_wind),                    # ud_wind
