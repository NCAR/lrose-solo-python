...
def radial_shear_ray(input_list_data: List, bad: float, seds_gate_diff_interval: int, dgi_clip_gate: int = None, boundary_mask: List = None):
    """
...
def radial_shear_masked(masked_array, seds_gate_diff_interval: int, boundary_masks: List = None):
    """
...
def radial_shear_field(radar: pyart.core.Radar, field: str, new_field: str, seds_gate_diff_interval: int, boundary_masks=None, sweep: int = 0):
